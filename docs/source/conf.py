...
# -*- coding: utf-8 -*-
#
# ploogz documentation build configuration file, created by
...
version = ploogz.__version__  # '0.1'
# The full version, including alpha/beta/rc tags.
release = ploogz.__release__  # '0.1'
...
latex_documents = [
    (master_doc, 'ploogz.tex', 'ploogz Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'ploogz', 'ploogz Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ploogz', 'ploogz Documentation',
     author, 'ploogz', 'One line description of project.',
     'Miscellaneous'),
]
